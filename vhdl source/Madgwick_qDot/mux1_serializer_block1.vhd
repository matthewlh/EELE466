...
ENTITY mux1_serializer_block1 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector32(0 TO 2);  -- ufix32_En16 [3]
        out0                              :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32_En16
        );
...
ARCHITECTURE rtl OF mux1_serializer_block1 IS
  ...
  -- Signals
  SIGNAL in0_unsigned                     : vector_of_unsigned32(0 TO 2);  -- ufix32_En16 [3]
  SIGNAL serial_in                        : vector_of_unsigned32(0 TO 2);  -- ufix32_En16 [3]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_unsigned32(0 TO 2);  -- ufix32 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_unsigned32(0 TO 2);  -- ufix32_En16 [3]
  SIGNAL s_s                              : unsigned(31 DOWNTO 0);  -- ufix32_En16
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_unsigned(0, 32));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_unsigned32(0 TO 1);
  BEGIN
