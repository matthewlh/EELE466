...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_qDot\codegen\Madgwick_qDot\hdlsrc\mux1_serializer_block2.vhd
...
ENTITY mux1_serializer_block2 IS
...
END mux1_serializer_block2;


ARCHITECTURE rtl OF mux1_serializer_block2 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed14(0 TO 2);  -- sfix14_En7 [3]
  SIGNAL serial_in                        : vector_of_signed14(0 TO 2);  -- sfix14_En7 [3]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_signed14(0 TO 2);  -- sfix14 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_signed14(0 TO 2);  -- sfix14_En7 [3]
  SIGNAL s_s                              : signed(13 DOWNTO 0);  -- sfix14_En7
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_signed(2#00000000000000#, 14));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_signed14(0 TO 1);
  BEGIN
