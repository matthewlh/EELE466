...
ARCHITECTURE rtl OF Madgwick_qDot_fixpt IS
  ...
  COMPONENT alpha0_deserializer
    PORT( clk                             :   IN    std_logic;
          ...
          out0                            :   OUT   vector_of_std_logic_vector28(0 TO 3)  -- sfix28_En21 [4]
          );
  END COMPONENT;
  ...
  COMPONENT mux1_serializer_block2
    PORT( clk                             :   IN    std_logic;
          ...
          enb_1_1_1                       :   IN    std_logic;
          enb                             :   IN    std_logic;
          in0                             :   IN    vector_of_std_logic_vector14(0 TO 2);  -- sfix14_En7 [3]
          out0                            :   OUT   std_logic_vector(13 DOWNTO 0)  -- sfix14_En7
          );
  END COMPONENT;
  ...
  COMPONENT alpha0_deserializer_block
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          in0                             :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En21
          out0                            :   OUT   vector_of_std_logic_vector28(0 TO 2)  -- sfix28_En21 [3]
          );
  END COMPONENT;
  ...
  SIGNAL gx_regout_2                      : signed(13 DOWNTO 0);  -- sfix14_En7
  SIGNAL gx_regout_3                      : signed(13 DOWNTO 0);  -- sfix14_En7
  ...
  SIGNAL c0_serial_0                      : vector_of_unsigned14(0 TO 3);  -- ufix14_En14 [4]
  ...
  SIGNAL gz_regout_2                      : signed(13 DOWNTO 0);  -- sfix14_En7
  SIGNAL gz_regout_3                      : signed(13 DOWNTO 0);  -- sfix14_En7
  ...
  SIGNAL gy_regout_2                      : signed(13 DOWNTO 0);  -- sfix14_En7
  SIGNAL gy_regout_3                      : signed(13 DOWNTO 0);  -- sfix14_En7
  SIGNAL gy_1                             : signed(13 DOWNTO 0);  -- sfix14_En7
  SIGNAL c0_serial_1                      : vector_of_signed14(0 TO 3);  -- sfix14_En7 [4]
  ...
  SIGNAL c0_serial_0_2                    : vector_of_unsigned14(0 TO 2);  -- ufix14_En14 [3]
  SIGNAL c0_serial_0_3                    : vector_of_std_logic_vector14(0 TO 2);  -- ufix14 [3]
  SIGNAL c0_serial_1_2                    : vector_of_signed14(0 TO 2);  -- sfix14_En7 [3]
  SIGNAL c0_serial_1_3                    : vector_of_std_logic_vector14(0 TO 2);  -- ufix14 [3]
  ...
  SIGNAL tmp_3                            : signed(27 DOWNTO 0);  -- sfix28_En21
  SIGNAL c0_serialOut_0_1                 : vector_of_std_logic_vector28(0 TO 2);  -- ufix28 [3]
  SIGNAL tmp_4                            : signed(28 DOWNTO 0);  -- sfix29_En21
  ...
  SIGNAL c0_serial_0_4                    : vector_of_unsigned14(0 TO 3);  -- ufix14_En14 [4]
  SIGNAL c0_serial_0_5                    : vector_of_std_logic_vector14(0 TO 3);  -- ufix14 [4]
  SIGNAL c0_serial_1_4                    : vector_of_signed14(0 TO 3);  -- sfix14_En7 [4]
  SIGNAL c0_serial_1_5                    : vector_of_std_logic_vector14(0 TO 3);  -- ufix14 [4]
  ...
  SIGNAL c0_serialOut_0_2                 : vector_of_std_logic_vector28(0 TO 3);  -- ufix28 [4]
  SIGNAL tmp_8                            : signed(27 DOWNTO 0);  -- sfix28_En21
  SIGNAL tmp_9                            : signed(28 DOWNTO 0);  -- sfix29_En21
  SIGNAL tmp_10                           : signed(27 DOWNTO 0);  -- sfix28_En21
  SIGNAL tmp_11                           : signed(28 DOWNTO 0);  -- sfix29_En21
  ...
  SIGNAL tmp_16                           : signed(29 DOWNTO 0);  -- sfix30_En21
  ...
  SIGNAL qDot3_1                          : signed(13 DOWNTO 0);  -- sfix14_En8
  ...
  SIGNAL tmp_22                           : signed(27 DOWNTO 0);  -- sfix28_En21
  SIGNAL tmp_23                           : signed(28 DOWNTO 0);  -- sfix29_En21
...
BEGIN
  ...
  Umux1_serializer_1 : mux1_serializer
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_0_1,  -- ufix14_En14 [4]
  ...
  Umux1_serializer_2 : mux1_serializer_block
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_1_1,  -- sfix14_En7 [4]
  ...
  Ualpha0_deserializer_1 : alpha0_deserializer
    PORT MAP( clk => clk,
              ...
              out0 => c0_serialOut_0  -- sfix28_En21 [4]
              );
  ...
  Umux1_serializer_3 : mux1_serializer_block1
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_0_3,  -- ufix14_En14 [3]
  ...
  Umux1_serializer_4 : mux1_serializer_block2
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_1_3,  -- sfix14_En7 [3]
  ...
  Ualpha0_deserializer_2 : alpha0_deserializer_block
    PORT MAP( clk => clk,
              ...
              enb_1_4_1 => enb_1_4_1,
              enb => enb,
              in0 => std_logic_vector(tmp_3),  -- sfix28_En21
              out0 => c0_serialOut_0_1  -- sfix28_En21 [3]
              );
  ...
  Umux1_serializer_5 : mux1_serializer
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_0_5,  -- ufix14_En14 [4]
  ...
  Umux1_serializer_6 : mux1_serializer_block
    PORT MAP( clk => clk,
              ...
              enb_1_1_1 => enb_1_1_1,
              enb => enb,
              in0 => c0_serial_1_5,  -- sfix14_En7 [4]
  ...
  Ualpha0_deserializer_3 : alpha0_deserializer
    PORT MAP( clk => clk,
              ...
              out0 => c0_serialOut_0_2  -- sfix28_En21 [4]
              );
...
--'Madgwick_qDot_fixpt:11' qDot1 = fi(fi(0.5, 0, 14, 14, fm)*(fi_signed(fi_signed(fi_uminus(q1)*gx) - q2*gy) - q3*gz), 1, 14, 7, fm);
  ...
  multiplier_cast <= signed(resize(q1_unsigned, 15));
  ...
  multiplier_mul_temp_1 <= multiplier_cast_1 * gx_signed;
  tmp_3 <= multiplier_mul_temp_1(27 DOWNTO 0);

  delayMatch_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      tmp_4 <= to_signed(2#00000000000000000000000000000#, 29);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_0 = '1' THEN
        tmp_4 <= tmp_1;
      END IF;
  ...
  p18qDot1_sub_cast <= resize(tmp_4, 30);
  p18qDot1_sub_cast_1 <= resize(tmp_5, 30);
...
-- 'Madgwick_qDot_fixpt:13' qDot3 = fi(fi(0.5, 0, 14, 14, fm)*(fi_signed(q0*gy) - q1*gz + q3*gx), 1, 14, 8, fm);
  -- 
  -- 'Madgwick_qDot_fixpt:19' coder.inline( 'always' );
  -- 
  -- 'Madgwick_qDot_fixpt:20' if isfi( a ) && ~(issigned( a ))
...
-- 'Madgwick_qDot_fixpt:12' qDot2 = fi(fi(0.5, 0, 14, 14, fm)*(fi_signed(q0*gx + q2*gz) - q3*gy), 1, 14, 7, fm);
  ...
  multiplier_mul_temp_2 <= multiplier_cast_2 * gz_signed_1;
  tmp_7 <= multiplier_mul_temp_2(27 DOWNTO 0);

  tmp_8 <= signed(c0_serialOut_0_2(2));

  tmp_9 <= resize(tmp_8, 29);

  tmp_10 <= signed(c0_serialOut_0(2));

  tmp_11 <= resize(tmp_10, 29);

  tmp_12 <= tmp_9 + tmp_11;

  tmp_13 <= signed(c0_serialOut_0_1(1));

  p17qDot2_sub_cast <= resize(tmp_12, 30);
  p17qDot2_sub_cast_1 <= resize(tmp_13, 30);
  ...
  p22tmp_sub_cast <= resize(tmp_14, 29);
  p22tmp_sub_cast_1 <= resize(tmp_15, 29);
  p22tmp_sub_temp <= p22tmp_sub_cast - p22tmp_sub_cast_1;
  tmp_16 <= resize(p22tmp_sub_temp, 30);
  ...
  p15qDot4_sub_cast <= resize(tmp_24, 30);
  p15qDot4_sub_cast_1 <= resize(tmp_25, 30);
