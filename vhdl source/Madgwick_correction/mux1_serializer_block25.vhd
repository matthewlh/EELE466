...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block25.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block25
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block25 IS
...
END mux1_serializer_block25;


ARCHITECTURE rtl OF mux1_serializer_block25 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed50(0 TO 3);  -- sfix50_En33 [4]
  SIGNAL serial_in                        : vector_of_signed50(0 TO 3);  -- sfix50_En33 [4]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_signed50(0 TO 2);  -- sfix50 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_signed50(0 TO 2);  -- sfix50_En33 [3]
  SIGNAL s_s                              : signed(49 DOWNTO 0);  -- sfix50_En33
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_signed(0, 50));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_signed50(0 TO 1);
  BEGIN
