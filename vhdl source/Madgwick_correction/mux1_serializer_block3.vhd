...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block3.vhd
...
ENTITY mux1_serializer_block3 IS
...
END mux1_serializer_block3;


ARCHITECTURE rtl OF mux1_serializer_block3 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed26(0 TO 1);  -- sfix26_En12 [2]
  SIGNAL serial_in                        : vector_of_signed26(0 TO 1);  -- sfix26_En12 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL s_s                              : signed(25 DOWNTO 0);  -- sfix26_En12
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(2#00000000000000000000000000#, 26);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
