...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block.vhd
...
ARCHITECTURE rtl OF mux1_serializer_block IS
  ...
  -- Signals
  SIGNAL in0_unsigned                     : vector_of_unsigned16(0 TO 3);  -- ufix16_En14 [4]
  SIGNAL serial_in                        : vector_of_unsigned16(0 TO 3);  -- ufix16_En14 [4]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_unsigned16(0 TO 2);  -- ufix16 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_unsigned16(0 TO 2);  -- ufix16_En14 [3]
  SIGNAL s_s                              : unsigned(15 DOWNTO 0);  -- ufix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_unsigned(16#0000#, 16));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_unsigned16(0 TO 1);
  BEGIN
