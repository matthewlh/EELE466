...
ARCHITECTURE rtl OF alpha0_deserializer_block24 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(64 DOWNTO 0);  -- sfix65_En52
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed65(0 TO 1);  -- sfix65 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed65(0 TO 1);  -- sfix65_En52 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed65(0 TO 1);  -- sfix65 [2]
  SIGNAL s_s                              : vector_of_signed65(0 TO 1);  -- sfix65_En52 [2]
