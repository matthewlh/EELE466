...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block11
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block11 IS
...
END mux1_serializer_block11;


ARCHITECTURE rtl OF mux1_serializer_block11 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed27(0 TO 1);  -- sfix27_En12 [2]
  SIGNAL serial_in                        : vector_of_signed27(0 TO 1);  -- sfix27_En12 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL s_s                              : signed(26 DOWNTO 0);  -- sfix27_En12
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(2#000000000000000000000000000#, 27);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
