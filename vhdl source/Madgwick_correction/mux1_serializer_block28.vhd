...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block28.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block28
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block28 IS
...
END mux1_serializer_block28;


ARCHITECTURE rtl OF mux1_serializer_block28 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed50(0 TO 1);  -- sfix50_En33 [2]
  SIGNAL serial_in                        : vector_of_signed50(0 TO 1);  -- sfix50_En33 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(49 DOWNTO 0);  -- sfix50
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(0, 50);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
