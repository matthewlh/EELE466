...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\alpha0_deserializer_block18.vhd
...
ARCHITECTURE rtl OF alpha0_deserializer_block18 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(47 DOWNTO 0);  -- sfix48_En33
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed48(0 TO 1);  -- sfix48 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed48(0 TO 1);  -- sfix48_En33 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed48(0 TO 1);  -- sfix48 [2]
  SIGNAL s_s                              : vector_of_signed48(0 TO 1);  -- sfix48_En33 [2]
