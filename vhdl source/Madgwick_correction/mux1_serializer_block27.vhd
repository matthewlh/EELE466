...
ARCHITECTURE rtl OF mux1_serializer_block27 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed30(0 TO 1);  -- sfix30_En25 [2]
  SIGNAL serial_in                        : vector_of_signed30(0 TO 1);  -- sfix30_En25 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL s_s                              : signed(29 DOWNTO 0);  -- sfix30_En25
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(2#000000000000000000000000000000#, 30);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
