...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block10.vhd
...
ARCHITECTURE rtl OF mux1_serializer_block10 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed37(0 TO 1);  -- sfix37_En24 [2]
  SIGNAL serial_in                        : vector_of_signed37(0 TO 1);  -- sfix37_En24 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(36 DOWNTO 0);  -- sfix37
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(0, 37);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
