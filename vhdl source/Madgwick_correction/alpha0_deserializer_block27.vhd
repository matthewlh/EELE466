...
ARCHITECTURE rtl OF alpha0_deserializer_block27 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(60 DOWNTO 0);  -- sfix61_En51
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed61(0 TO 1);  -- sfix61 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed61(0 TO 1);  -- sfix61_En51 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed61(0 TO 1);  -- sfix61 [2]
  SIGNAL s_s                              : vector_of_signed61(0 TO 1);  -- sfix61_En51 [2]
