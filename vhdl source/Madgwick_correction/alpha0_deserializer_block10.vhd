...
ARCHITECTURE rtl OF alpha0_deserializer_block10 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(27 DOWNTO 0);  -- sfix28_En22
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed28(0 TO 1);  -- sfix28_En22 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL s_s                              : vector_of_signed28(0 TO 1);  -- sfix28_En22 [2]
