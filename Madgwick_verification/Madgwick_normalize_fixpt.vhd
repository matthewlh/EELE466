...
ARCHITECTURE rtl OF Madgwick_normalize_fixpt IS
  ...
  SIGNAL dotproduct_sig                   : unsigned(31 DOWNTO 0);          -- ufix32_En16
  SIGNAL rsr_out                          : STD_LOGIC_VECTOR(31 DOWNTO 0);  -- ufix32_En16
...
BEGIN
  ...
  Madgwick_normalize_fixpt_1_output : PROCESS (ax_1, ay_1, az_1, aw_1, rsr_out)
  ...
  BEGIN
    ...
    --'Madgwick_normalize_fixpt:29' OUTPUT_Y = fi(fi_div(fi(1, 0, 1, 0, fm), sqrt( INPUT_X )), 0, 24, 25, fm);
