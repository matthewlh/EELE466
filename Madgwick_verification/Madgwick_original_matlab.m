...
function [q0, q1, q2, q3] = Madgwick_original_matlab(q0, q1, q2, q3, gx, gy, gz, ax, ay, az, mx, my, mz)

sampleFreq	= 512.0;            % sample frequency in Hz
sampleTime  = 1/sampleFreq;
betaDef     = 0.10009765625;    % 2 * proportional gain
beta        = betaDef;          % 2 * proportional gain (Kp)
