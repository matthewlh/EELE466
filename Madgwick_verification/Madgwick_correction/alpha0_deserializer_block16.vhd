...
ARCHITECTURE rtl OF alpha0_deserializer_block16 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(47 DOWNTO 0);  -- sfix48_En32
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed48(0 TO 1);  -- sfix48 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed48(0 TO 1);  -- sfix48_En32 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed48(0 TO 1);  -- sfix48 [2]
  SIGNAL s_s                              : vector_of_signed48(0 TO 1);  -- sfix48_En32 [2]
