...
ARCHITECTURE rtl OF alpha0_deserializer_block22 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(48 DOWNTO 0);  -- sfix49_En34
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed49(0 TO 1);  -- sfix49 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed49(0 TO 1);  -- sfix49_En34 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed49(0 TO 1);  -- sfix49 [2]
  SIGNAL s_s                              : vector_of_signed49(0 TO 1);  -- sfix49_En34 [2]
