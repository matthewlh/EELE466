...
ARCHITECTURE rtl OF alpha0_deserializer_block3 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(49 DOWNTO 0);  -- sfix50_En24
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed50(0 TO 1);  -- sfix50 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed50(0 TO 1);  -- sfix50_En24 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed50(0 TO 1);  -- sfix50 [2]
  SIGNAL s_s                              : vector_of_signed50(0 TO 1);  -- sfix50_En24 [2]
