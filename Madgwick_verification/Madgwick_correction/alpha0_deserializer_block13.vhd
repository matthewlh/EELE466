...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\alpha0_deserializer_block13.vhd
...
ARCHITECTURE rtl OF alpha0_deserializer_block13 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(48 DOWNTO 0);  -- sfix49_En45
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed49(0 TO 3);  -- sfix49 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed49(0 TO 3);  -- sfix49_En45 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed49(0 TO 3);  -- sfix49 [4]
  SIGNAL s_s                              : vector_of_signed49(0 TO 3);  -- sfix49_En45 [4]
