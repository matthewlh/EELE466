...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer.vhd
...
ENTITY mux1_serializer IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector14(0 TO 1);  -- sfix14_En12 [2]
        out0                              :   OUT   std_logic_vector(13 DOWNTO 0)  -- sfix14_En12
        );
END mux1_serializer;
...
ARCHITECTURE rtl OF mux1_serializer IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed14(0 TO 1);  -- sfix14_En12 [2]
  SIGNAL serial_in                        : vector_of_signed14(0 TO 1);  -- sfix14_En12 [2]
  ...
  SIGNAL s_s                              : signed(13 DOWNTO 0);  -- sfix14_En12
