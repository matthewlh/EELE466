...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer_block14.vhd
...
ENTITY mux1_serializer_block14 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector16(0 TO 1);  -- sfix16_En14 [2]
...
ARCHITECTURE rtl OF mux1_serializer_block14 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL serial_in                        : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(15 DOWNTO 0);  -- sfix16
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
