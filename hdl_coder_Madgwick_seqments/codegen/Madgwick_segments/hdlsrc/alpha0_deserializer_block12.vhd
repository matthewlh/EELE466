...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\alpha0_deserializer_block12.vhd
...
ENTITY alpha0_deserializer_block12 IS
  PORT( clk                               :   IN    std_logic;
        ...
        out0                              :   OUT   vector_of_std_logic_vector31(0 TO 1)  -- sfix31_En25 [2]
        );
...
ARCHITECTURE rtl OF alpha0_deserializer_block12 IS
  ...
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed31(0 TO 1);  -- sfix31_En25 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed31(0 TO 1);  -- sfix31 [2]
  SIGNAL s_s                              : vector_of_signed31(0 TO 1);  -- sfix31_En25 [2]
