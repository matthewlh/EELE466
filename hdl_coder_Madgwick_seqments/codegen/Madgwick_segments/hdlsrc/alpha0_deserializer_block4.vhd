...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\alpha0_deserializer_block4.vhd
...
ENTITY alpha0_deserializer_block4 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En26
        out0                              :   OUT   vector_of_std_logic_vector37(0 TO 1)  -- sfix37_En26 [2]
        );
...
ARCHITECTURE rtl OF alpha0_deserializer_block4 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(36 DOWNTO 0);  -- sfix37_En26
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed37(0 TO 1);  -- sfix37 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed37(0 TO 1);  -- sfix37_En26 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed37(0 TO 1);  -- sfix37 [2]
  SIGNAL s_s                              : vector_of_signed37(0 TO 1);  -- sfix37_En26 [2]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha0_deserializer_tap_regrsvd <= (OTHERS => to_signed(0, 37));
  ...
  BEGIN
    IF reset = '1' THEN
      bypass_reg_regrsvd <= (OTHERS => to_signed(0, 37));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_1 = '1' THEN
