...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer_block23.vhd
...
ENTITY mux1_serializer_block23 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector30(0 TO 1);  -- sfix30_En23 [2]
        out0                              :   OUT   std_logic_vector(29 DOWNTO 0)  -- sfix30_En23
        );
...
ARCHITECTURE rtl OF mux1_serializer_block23 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed30(0 TO 1);  -- sfix30_En23 [2]
  SIGNAL serial_in                        : vector_of_signed30(0 TO 1);  -- sfix30_En23 [2]
  ...
  SIGNAL s_s                              : signed(29 DOWNTO 0);  -- sfix30_En23
