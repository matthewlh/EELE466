...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer_block22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block22
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block22 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_2_1                         :   IN    std_logic;
        enb_1_1_1                         :   IN    std_logic;
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector32(0 TO 1);  -- sfix32_En26 [2]
        out0                              :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32_En26
        );
END mux1_serializer_block22;


ARCHITECTURE rtl OF mux1_serializer_block22 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed32(0 TO 1);  -- sfix32_En26 [2]
  SIGNAL serial_in                        : vector_of_signed32(0 TO 1);  -- sfix32_En26 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(31 DOWNTO 0);  -- sfix32
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
