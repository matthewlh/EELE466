...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\alpha0_deserializer.vhd
...
ENTITY alpha0_deserializer IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En19
        out0                              :   OUT   vector_of_std_logic_vector28(0 TO 1)  -- sfix28_En19 [2]
        );
...
ARCHITECTURE rtl OF alpha0_deserializer IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(27 DOWNTO 0);  -- sfix28_En19
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed28(0 TO 1);  -- sfix28_En19 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  SIGNAL s_s                              : vector_of_signed28(0 TO 1);  -- sfix28_En19 [2]
