...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer_block4.vhd
...
ENTITY mux1_serializer_block4 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector20(0 TO 1);  -- sfix20_En14 [2]
...
ARCHITECTURE rtl OF mux1_serializer_block4 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed20(0 TO 1);  -- sfix20_En14 [2]
  SIGNAL serial_in                        : vector_of_signed20(0 TO 1);  -- sfix20_En14 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(19 DOWNTO 0);  -- sfix20
  SIGNAL s_s                              : signed(19 DOWNTO 0);  -- sfix20_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(16#00000#, 20);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
