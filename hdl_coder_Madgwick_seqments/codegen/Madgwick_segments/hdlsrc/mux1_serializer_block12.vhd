...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_seqments\codegen\Madgwick_segments\hdlsrc\mux1_serializer_block12.vhd
...
ENTITY mux1_serializer_block12 IS
  PORT( clk                               :   IN    std_logic;
        ...
        enb                               :   IN    std_logic;
        in0                               :   IN    vector_of_std_logic_vector17(0 TO 1);  -- sfix17_En14 [2]
...
ARCHITECTURE rtl OF mux1_serializer_block12 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed17(0 TO 1);  -- sfix17_En14 [2]
  SIGNAL serial_in                        : vector_of_signed17(0 TO 1);  -- sfix17_En14 [2]
