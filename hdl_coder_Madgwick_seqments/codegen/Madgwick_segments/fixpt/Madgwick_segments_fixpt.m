...
mx = fi(mx_1, 1, 14, 9, fm);
my = fi(my_1, 1, 14, 9, fm);
mz = fi(mz_1, 1, 14, 9, fm);
...
qDot1 = fi(fmo_1, 1, 14, 7, fm);
qDot2 = fi(fmo_2, 1, 14, 7, fm);
qDot3 = fi(fmo_3, 1, 14, 7, fm);
qDot4 = fi(fmo_4, 1, 14, 7, fm);
[fmo_5,fmo_6,fmo_7,fmo_8] = f14_Madgwick_normalize( ax, ay, az, fi(0, 0, 1, 0, fm) );
ax = fi(fmo_5, 1, 14, 9, fm);
ay = fi(fmo_6, 1, 14, 9, fm);
az = fi(fmo_7, 1, 14, 9, fm);
unused1 = fi(fmo_8, 0, 1, 0, fm);
[fmo_9,fmo_10,fmo_11,fmo_12] = f14_Madgwick_normalize( mx, my, mz, fi(0, 0, 1, 0, fm) );
mx = fi(fmo_9, 1, 14, 9, fm);
my = fi(fmo_10, 1, 14, 9, fm);
mz = fi(fmo_11, 1, 14, 9, fm);
unused1 = fi(fmo_12, 0, 1, 0, fm);
[fmo_13,fmo_14,fmo_15,fmo_16] = f15_Madgwick_correction( q0, q1, q2, q3, ax, ay, az, mx, my, mz );
s0 = fi(fmo_13, 1, 14, 8, fm);
s1 = fi(fmo_14, 1, 14, 7, fm);
s2 = fi(fmo_15, 1, 14, 7, fm);
s3 = fi(fmo_16, 1, 14, 7, fm);
[fmo_17,fmo_18,fmo_19,fmo_20] = f14_Madgwick_normalize( s0, s1, s2, s3 );
s0 = fi(fmo_17, 1, 14, 8, fm);
s1 = fi(fmo_18, 1, 14, 7, fm);
s2 = fi(fmo_19, 1, 14, 7, fm);
s3 = fi(fmo_20, 1, 14, 7, fm);
[fmo_21,fmo_22,fmo_23,fmo_24] = f16_Madgwick_update( q0, q1, q2, q3, qDot1, qDot2, qDot3, qDot4, s0, s1, s2, s3, beta, sampleTime );
q0 = fi(fmo_21, 1, 14, 12, fm);
q1 = fi(fmo_22, 1, 14, 12, fm);
q2 = fi(fmo_23, 1, 14, 12, fm);
q3 = fi(fmo_24, 1, 14, 12, fm);
[fmo_25,fmo_26,fmo_27,fmo_28] = f14_Madgwick_normalize( q0, q1, q2, q3 );
q0 = fi(fmo_25, 1, 14, 12, fm);
q1 = fi(fmo_26, 1, 14, 12, fm);
q2 = fi(fmo_27, 1, 14, 12, fm);
q3 = fi(fmo_28, 1, 14, 12, fm);
end
...
aw = fi(aw_1, 1, 14, 7, fm);
ax = fi(ax_1, 1, 14, 8, fm);
ay = fi(ay_1, 1, 14, 7, fm);
az = fi(az_1, 1, 14, 7, fm);

dotproduct = fi(ax*ax + ay*ay + az*az + aw*aw, 0, 14, 0, fm);
if dotproduct~=fi(0, 0, 1, 0, fm)
    recipNorm = fi(fi_div(fi(1, 0, 1, 0, fm), sqrt( dotproduct )), 0, 14, 12, fm);
    ax = fi(ax*recipNorm, 1, 14, 8, fm);
    ay = fi(ay*recipNorm, 1, 14, 7, fm);
    az = fi(az*recipNorm, 1, 14, 7, fm);
    aw = fi(aw*recipNorm, 1, 14, 7, fm);
end
end
...
v2q0mx = fi(fi(2.0, 0, 2, 0, fm)*q0*mx, 1, 14, 12, fm);
v2q0my = fi(fi(2.0, 0, 2, 0, fm)*q0*my, 1, 14, 12, fm);
v2q0mz = fi(fi(2.0, 0, 2, 0, fm)*q0*mz, 1, 14, 12, fm);
v2q1mx = fi(fi(2.0, 0, 2, 0, fm)*q1*mx, 1, 14, 12, fm);
v2q0 = fi(fi(2.0, 0, 2, 0, fm)*q0, 0, 14, 12, fm);
