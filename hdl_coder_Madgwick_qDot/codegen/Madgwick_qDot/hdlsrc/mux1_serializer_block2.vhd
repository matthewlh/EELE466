...
ARCHITECTURE rtl OF mux1_serializer_block2 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed32(0 TO 2);  -- sfix32_En16 [3]
  SIGNAL serial_in                        : vector_of_signed32(0 TO 2);  -- sfix32_En16 [3]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_signed32(0 TO 2);  -- sfix32 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_signed32(0 TO 2);  -- sfix32_En16 [3]
  SIGNAL s_s                              : signed(31 DOWNTO 0);  -- sfix32_En16
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_signed(0, 32));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_signed32(0 TO 1);
  BEGIN
