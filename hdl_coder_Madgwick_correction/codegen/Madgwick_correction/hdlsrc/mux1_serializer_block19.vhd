...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block19.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block19
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block19 IS
...
END mux1_serializer_block19;


ARCHITECTURE rtl OF mux1_serializer_block19 IS

  -- Signals
  SIGNAL in0_unsigned                     : vector_of_unsigned24(0 TO 3);  -- ufix24_En21 [4]
  SIGNAL serial_in                        : vector_of_unsigned24(0 TO 3);  -- ufix24_En21 [4]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : vector_of_unsigned24(0 TO 2);  -- ufix24 [3]
  SIGNAL mux1_serializer_data_next        : vector_of_unsigned24(0 TO 2);  -- ufix24_En21 [3]
  SIGNAL s_s                              : unsigned(23 DOWNTO 0);  -- ufix24_En21
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= (OTHERS => to_unsigned(16#000000#, 24));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  mux1_serializer_output : PROCESS (mux1_serializer_data, serial_in, in_vld)
    VARIABLE tempv : vector_of_unsigned24(0 TO 1);
  BEGIN
