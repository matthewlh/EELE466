...
ARCHITECTURE rtl OF alpha0_deserializer_block8 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(35 DOWNTO 0);  -- sfix36_En28
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed36(0 TO 1);  -- sfix36 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed36(0 TO 1);  -- sfix36_En28 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed36(0 TO 1);  -- sfix36 [2]
  SIGNAL s_s                              : vector_of_signed36(0 TO 1);  -- sfix36_En28 [2]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha0_deserializer_tap_regrsvd <= (OTHERS => to_signed(0, 36));
  ...
  BEGIN
    IF reset = '1' THEN
      bypass_reg_regrsvd <= (OTHERS => to_signed(0, 36));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_1 = '1' THEN
