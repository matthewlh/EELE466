...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block26.vhd
...
ARCHITECTURE rtl OF mux1_serializer_block26 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed49(0 TO 1);  -- sfix49_En33 [2]
  SIGNAL serial_in                        : vector_of_signed49(0 TO 1);  -- sfix49_En33 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(48 DOWNTO 0);  -- sfix49
  SIGNAL s_s                              : signed(48 DOWNTO 0);  -- sfix49_En33
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(0, 49);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
