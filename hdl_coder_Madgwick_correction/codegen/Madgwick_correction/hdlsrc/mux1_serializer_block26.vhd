...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block26.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block26
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block26 IS
...
END mux1_serializer_block26;


ARCHITECTURE rtl OF mux1_serializer_block26 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed50(0 TO 3);  -- sfix50_En34 [4]
  SIGNAL serial_in                        : vector_of_signed50(0 TO 3);  -- sfix50_En34 [4]
  ...
  SIGNAL mux1_serializer_data_next        : vector_of_signed50(0 TO 2);  -- sfix50_En34 [3]
  SIGNAL s_s                              : signed(49 DOWNTO 0);  -- sfix50_En34
