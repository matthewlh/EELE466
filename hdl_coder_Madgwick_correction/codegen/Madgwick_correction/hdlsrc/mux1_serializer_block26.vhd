...
ARCHITECTURE rtl OF mux1_serializer_block26 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed32(0 TO 3);  -- sfix32_En26 [4]
  SIGNAL serial_in                        : vector_of_signed32(0 TO 3);  -- sfix32_En26 [4]
  ...
  SIGNAL mux1_serializer_data_next        : vector_of_signed32(0 TO 2);  -- sfix32_En26 [3]
  SIGNAL s_s                              : signed(31 DOWNTO 0);  -- sfix32_En26
