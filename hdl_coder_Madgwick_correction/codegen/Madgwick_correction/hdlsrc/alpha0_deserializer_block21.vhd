...
ARCHITECTURE rtl OF alpha0_deserializer_block21 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(28 DOWNTO 0);  -- sfix29_En26
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed29(0 TO 1);  -- sfix29 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed29(0 TO 1);  -- sfix29_En26 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed29(0 TO 1);  -- sfix29 [2]
  SIGNAL s_s                              : vector_of_signed29(0 TO 1);  -- sfix29_En26 [2]
