...
-- File Name: C:\Users\w92p177\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\alpha0_deserializer_block21.vhd
...
ARCHITECTURE rtl OF alpha0_deserializer_block21 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(105 DOWNTO 0);  -- sfix106_En78
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed106(0 TO 3);  -- sfix106 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed106(0 TO 3);  -- sfix106_En78 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed106(0 TO 3);  -- sfix106 [4]
  SIGNAL s_s                              : vector_of_signed106(0 TO 3);  -- sfix106_En78 [4]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha0_deserializer_tap_regrsvd <= (OTHERS => to_signed(0, 106));
  ...
  BEGIN
    IF reset = '1' THEN
      bypass_reg_regrsvd <= (OTHERS => to_signed(0, 106));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_1 = '1' THEN
