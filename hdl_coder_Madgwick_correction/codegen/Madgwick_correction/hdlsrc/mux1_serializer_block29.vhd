...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block29.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mux1_serializer_block29
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY mux1_serializer_block29 IS
...
END mux1_serializer_block29;


ARCHITECTURE rtl OF mux1_serializer_block29 IS

  -- Signals
  SIGNAL in0_signed                       : vector_of_signed48(0 TO 1);  -- sfix48_En33 [2]
  SIGNAL serial_in                        : vector_of_signed48(0 TO 1);  -- sfix48_En33 [2]
