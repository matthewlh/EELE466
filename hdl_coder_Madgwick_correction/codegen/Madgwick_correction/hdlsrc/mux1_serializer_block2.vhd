...
ARCHITECTURE rtl OF mux1_serializer_block2 IS
  ...
  -- Signals
  SIGNAL in0_unsigned                     : vector_of_unsigned16(0 TO 1);  -- ufix16_En14 [2]
  SIGNAL serial_in                        : vector_of_unsigned16(0 TO 1);  -- ufix16_En14 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : unsigned(15 DOWNTO 0);  -- ufix16
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_unsigned(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
