...
ARCHITECTURE rtl OF alpha0_deserializer_block13 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(27 DOWNTO 0);  -- sfix28_En25
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed28(0 TO 3);  -- sfix28 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed28(0 TO 3);  -- sfix28_En25 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed28(0 TO 3);  -- sfix28 [4]
  SIGNAL s_s                              : vector_of_signed28(0 TO 3);  -- sfix28_En25 [4]
