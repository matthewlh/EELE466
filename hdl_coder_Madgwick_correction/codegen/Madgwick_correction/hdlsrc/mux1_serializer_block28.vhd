...
ARCHITECTURE rtl OF mux1_serializer_block28 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed33(0 TO 1);  -- sfix33_En26 [2]
  SIGNAL serial_in                        : vector_of_signed33(0 TO 1);  -- sfix33_En26 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL s_s                              : signed(32 DOWNTO 0);  -- sfix33_En26
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(0, 33);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
