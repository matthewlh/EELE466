...
ARCHITECTURE rtl OF mux1_serializer_block20 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : vector_of_signed15(0 TO 1);  -- sfix15_En12 [2]
  SIGNAL serial_in                        : vector_of_signed15(0 TO 1);  -- sfix15_En12 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL s_s                              : signed(14 DOWNTO 0);  -- sfix15_En12
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_signed(2#000000000000000#, 15);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
