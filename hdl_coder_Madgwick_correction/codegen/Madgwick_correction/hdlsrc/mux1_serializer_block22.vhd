...
-- File Name: C:\Users\z68j959\Documents\GitHub\EELE466\hdl_coder_Madgwick_correction\codegen\Madgwick_correction\hdlsrc\mux1_serializer_block22.vhd
...
ARCHITECTURE rtl OF mux1_serializer_block22 IS
  ...
  -- Signals
  SIGNAL in0_unsigned                     : vector_of_unsigned28(0 TO 1);  -- ufix28_En26 [2]
  SIGNAL serial_in                        : vector_of_unsigned28(0 TO 1);  -- ufix28_En26 [2]
  SIGNAL mux1_serializer_bypass_regrsvd   : std_logic;  -- ufix1
  SIGNAL in_vld                           : std_logic;
  SIGNAL mux1_serializer_data             : unsigned(27 DOWNTO 0);  -- ufix28
  SIGNAL s_s                              : unsigned(27 DOWNTO 0);  -- ufix28_En26
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      mux1_serializer_data <= to_unsigned(16#0000000#, 28);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
