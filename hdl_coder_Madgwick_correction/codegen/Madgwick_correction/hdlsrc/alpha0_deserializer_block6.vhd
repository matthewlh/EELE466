...
ARCHITECTURE rtl OF alpha0_deserializer_block6 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(32 DOWNTO 0);  -- sfix33_En27
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed33(0 TO 3);  -- sfix33 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed33(0 TO 3);  -- sfix33_En27 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed33(0 TO 3);  -- sfix33 [4]
  SIGNAL s_s                              : vector_of_signed33(0 TO 3);  -- sfix33_En27 [4]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha0_deserializer_tap_regrsvd <= (OTHERS => to_signed(0, 33));
  ...
  BEGIN
    IF reset = '1' THEN
      bypass_reg_regrsvd <= (OTHERS => to_signed(0, 33));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_1 = '1' THEN
