...
ARCHITECTURE rtl OF alpha0_deserializer_block25 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(61 DOWNTO 0);  -- sfix62_En52
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed62(0 TO 3);  -- sfix62 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed62(0 TO 3);  -- sfix62_En52 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed62(0 TO 3);  -- sfix62 [4]
  SIGNAL s_s                              : vector_of_signed62(0 TO 3);  -- sfix62_En52 [4]
