...
ARCHITECTURE rtl OF alpha0_deserializer_block19 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(49 DOWNTO 0);  -- sfix50_En46
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed50(0 TO 3);  -- sfix50 [4]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed50(0 TO 3);  -- sfix50_En46 [4]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed50(0 TO 3);  -- sfix50 [4]
  SIGNAL s_s                              : vector_of_signed50(0 TO 3);  -- sfix50_En46 [4]
