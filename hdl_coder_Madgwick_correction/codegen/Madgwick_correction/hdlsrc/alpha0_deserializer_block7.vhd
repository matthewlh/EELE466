...
ARCHITECTURE rtl OF alpha0_deserializer_block7 IS
  ...
  -- Signals
  SIGNAL in0_signed                       : signed(33 DOWNTO 0);  -- sfix34_En27
  SIGNAL alpha0_deserializer_tap_regrsvd  : vector_of_signed34(0 TO 1);  -- sfix34 [2]
  SIGNAL alpha0_deserializer_tapout       : vector_of_signed34(0 TO 1);  -- sfix34_En27 [2]
  SIGNAL bypass_reg_regrsvd               : vector_of_signed34(0 TO 1);  -- sfix34 [2]
  SIGNAL s_s                              : vector_of_signed34(0 TO 1);  -- sfix34_En27 [2]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      alpha0_deserializer_tap_regrsvd <= (OTHERS => to_signed(0, 34));
  ...
  BEGIN
    IF reset = '1' THEN
      bypass_reg_regrsvd <= (OTHERS => to_signed(0, 34));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_1 = '1' THEN
